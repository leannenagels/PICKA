...
#    Version 0.3 - PICKA - 2018-03-04
#    This special PICA version has no dependency on numpy to facilitate portability.
#-------------------------------------------------------------------------
#
#    Copyright 2018 Etienne Gaudrain <egaudrain@gmail.com>
#
...
class sqlShort:
	def __init__(self, **kwarg):
		...
		if self.dbtype=='mysql':
			...
			# Removed so we don't have to include numpy in the PICKA version of sqlShort
