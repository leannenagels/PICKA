        ...
        function updateBuildInfo(buildInfo, context)
            ...
            switch arch
                case {'win32','win64'}
                    ...
                    nonBuildFiles = {'libmwgetnumcores', 'boost_thread-vc120-mt-1_56',...
                        'boost_system-vc120-mt-1_56', 'boost_date_time-vc120-mt-1_56',...
                        'boost_chrono-vc120-mt-1_56'};
                ...
                case {'glnxa64','maci64'}
                    ...
                    if strcmp(arch,'glnxa64')
                        ...
                        nonBuildFilesBoost = {'libboost_thread.so.1.56.0'};
                        nonBuildFilesBoost{end+1} = 'libboost_system.so.1.56.0';
                        nonBuildFilesBoost{end+1} = 'libboost_date_time.so.1.56.0';
                        nonBuildFilesBoost{end+1} = 'libboost_chrono.so.1.56.0';
                        nonBuildFilesBoost = strcat(binArch,nonBuildFilesBoost);
                        nonBuildFilesNoExt = [nonBuildFilesBoost nonBuildFilesStd];
                    else
                        libstdcpp          = [];
                        nonBuildFilesNoExt = {'libboost_thread'};
                        nonBuildFilesNoExt{end+1} = 'libboost_system';
                        nonBuildFilesNoExt{end+1} = 'libboost_date_time';
                        nonBuildFilesNoExt{end+1} = 'libboost_chrono';
