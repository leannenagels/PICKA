classdef Morphop_nonflat_Buildable < coder.ExternalDependency %#codegen
    ...
    methods (Static)
        ...
        function name = getDescriptiveName(~)
            name = 'Morphop_nonflat_Buildable';
        end
        ...
        function updateBuildInfo(buildInfo, context)
            ...
            switch arch
                case {'win32','win64'}
                    ...
                    linkFiles   = {'libmwmorphop_nonflat'}; %#ok<*EMCA>
                    linkFiles   = strcat(linkFiles, linkLibExt);
                    
                case {'glnxa64','maci64'}
                    linkFiles   = {'mwmorphop_nonflat','mwnhood'};
                    linkLibPath = binArch;
            ...
            % Non-build files
            nonBuildFiles = {'libmwnhood', 'libmwmorphop_nonflat'};
        ...
        function b = morphop_nonflat(...
                fcnName, a, asize, adims, nhood, nsize, ndims, height, b)
            coder.inline('always');
            coder.cinclude('libmwmorphop_nonflat.h');
